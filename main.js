...
const token = "TOKEN";
const publicIds = [АЙДИ ГРУПП ПОСЛЕ ЗАПЯТОЙ, 161623929, 165420048, 180760688, 16057855, 149951497, 138789875, 62309918, 173437827, 107412143, 31528152, 152606132, 30049821, 93750603, 87945614];
const message = `
